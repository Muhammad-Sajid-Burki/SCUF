...
class AllFieldsFormBloc extends FormBloc<String, String> {
  ...
  final collegeName = TextFieldBloc(validators: [FieldBlocValidators.required],
  );

  final collegeAddress = TextFieldBloc(validators: [FieldBlocValidators.required],);
...
class CollegeRegisteration extends StatefulWidget {
  const CollegeRegisteration({Key? key}) : super(key: key);

  @override
  State<CollegeRegisteration> createState() => _CollegeRegisterationState();
}

class _CollegeRegisterationState extends State<CollegeRegisteration> {
      ...
      child: Builder(
        builder: (context) {
          ...
          return Theme(
            ...
            child: Scaffold(
              appBar: AppBar(title: const Text('College Registeration')),
              ...
              body: FormBlocListener<AllFieldsFormBloc, String, String>(
                ...
                onSuccess: (context, state) async {
                  ...
                  final String collegeName = formBloc.collegeName.value;
                  final String collegeAddress = formBloc.collegeAddress.value;
                  ...
                  FirebaseFirestore.instance.collection('Institutes').doc('data')
                    ...
                    'College Image': imageUrlDownload
                    ...
                    child: Column(
                      children: <Widget>[
                        TextFieldBlocBuilder(
                          ...
                          textFieldBloc: formBloc.collegeName,
                        ...
                        TextFieldBlocBuilder(
                          keyboardType: TextInputType.text,
                          textFieldBloc: formBloc.collegeAddress,
                          decoration: const InputDecoration(
  ...
  Future uploadFile() async {
    ...
    final destination = 'college/files/$fileName';
  ...
  Future uploadImage() async {
    ...
    final destination = 'college/images/$imageName';
