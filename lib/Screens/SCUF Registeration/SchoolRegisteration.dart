...
import 'package:flutter_web_to_app_design/Screens/Institutes/InstituteSignIn.dart';
...
class AllFieldsFormBloc extends FormBloc<String, String> {
  ...
  final schoolName = TextFieldBloc(validators: [FieldBlocValidators.required],
  );

  final schoolAddress = TextFieldBloc(validators: [FieldBlocValidators.required],);
...
class SchoolRegisteration extends StatefulWidget {
  const SchoolRegisteration({Key? key}) : super(key: key);

  @override
  State<SchoolRegisteration> createState() => _SchoolRegisterationState();
}

class _SchoolRegisterationState extends State<SchoolRegisteration> {
      ...
      child: Builder(
        builder: (context) {
          ...
          return Theme(
            ...
            child: Scaffold(
              appBar: AppBar(title: const Text('School Registeration')),
              ...
              body: FormBlocListener<AllFieldsFormBloc, String, String>(
                ...
                onSuccess: (context, state) async {
                  ...
                  final String schoolName = formBloc.schoolName.value;
                  final String schoolAddress = formBloc.schoolAddress.value;
                  ...
                  child: Padding(
                    ...
                    TextFieldBlocBuilder(
                      keyboardType: TextInputType.text,
                          textFieldBloc: formBloc.schoolName,
                        ...
                        TextFieldBlocBuilder(
                          keyboardType: TextInputType.text,
                          textFieldBloc: formBloc.schoolAddress,
                          decoration: const InputDecoration(
  ...
  Future uploadFile() async {
    ...
    final destination = 'school/files/$fileName';
  ...
  Future uploadImage() async {
    ...
    final destination = 'school/images/$imageName';
