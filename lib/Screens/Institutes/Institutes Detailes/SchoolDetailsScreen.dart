...
class SchoolDetailsScreen extends StatelessWidget {
  ...
  SchoolDetailsScreen({Key? key, this.course}) : super(key: key);
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Center(
                      child: Hero(
                        tag: '${course!['School Name']}',
                        child: ProductPoster(
                          size: size,
                          image: course!['School Image'],
                        ),
                      ),
                    ),
                    Padding(
              ...
              infoContainer("Subject : ${course!['Subject']}", Icons.subject),
              InkWell(
                  onTap: () {
                    _launchURL();
                  },
                  child: infoContainer("Link : ${course!['Link']}", Icons.link)),
              InkWell(
                  onTap: () {
  ...
  void _launchURL() async {
    if (!await launch(course!['Link'])) throw 'Could not launch ${course!['Link']}';
  }
